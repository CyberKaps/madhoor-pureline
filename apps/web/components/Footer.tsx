    ...
    <footer className="bg-gradient-to-b from-[#c9c0a8] to-[#b8ae93] border-t-4 border-[#5a7c5e]">
      ...
      <div className="border-t-2 border-[#5a7c5e] bg-[#1f3a2e] py-6">
          <p className="text-[#dcd6c4] text-sm text-center">
            © 2025 Madhoor Pureline. All rights reserved. | Devloped by Kalpesh - <a href="https://www.cyberkaps.me" target="_blank" rel="noopener noreferrer" className="underline text-white text-lg">Contact Me</a>
          </p>
        </div>
    </footer>
  );
